...
mod and_method_is_static {
    ...
    fn and_continue_mocked_then_runs_with_modified_args() {
        unsafe {
            Struct::static_method.mock_raw(|a: bool| MockResult::Continue((!a, )));
        }
...
mod and_method_is_ref_method {
    ...
    fn and_continue_mocked_then_runs_with_modified_args() {
        ...
        unsafe {
            Struct::ref_method.mock_raw(|_, b: bool| MockResult::Continue((&struct_3, !b)));
        }
    ...
    fn and_return_mocked_then_returns_mocking_result() {
        let struct_2 = Struct(2);
        unsafe {
            Struct::ref_method.mock_raw(|a: &Struct, b| MockResult::Return(format!("mocked {} {}", a.0, b), ));
        }
...
mod and_method_is_ref_mut_method {
    ...
    fn and_continue_mocked_then_runs_with_modified_args() {
        ...
        let struct_3 = Struct(3);
        unsafe {
            Struct::ref_mut_method.mock_raw(|_, b: bool| MockResult::Continue((as_mut(&struct_3), !b)));
        }
    ...
    fn and_return_mocked_then_returns_mocking_result() {
        let mut struct_2 = Struct(2);
        unsafe {
            Struct::ref_mut_method.mock_raw(|a: &mut Struct, b| MockResult::Return(format!("mocked {} {}", a.0, b), ));
        }
...
mod and_method_is_val_method {
    ...
    fn and_continue_mocked_then_runs_with_modified_args() {
        unsafe {
            Struct::val_method.mock_raw(move |_, b: bool| MockResult::Continue((Struct(3), !b)));
        }
    ...
    fn and_return_mocked_then_returns_mocking_result() {
        unsafe {
            Struct::val_method.mock_raw(|a: Struct, b| MockResult::Return(format!("mocked {} {}", a.0, b), ));
        }
